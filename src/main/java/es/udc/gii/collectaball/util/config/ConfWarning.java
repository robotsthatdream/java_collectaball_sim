...
public class ConfWarning {    
    private static final String WARNING_TEMPLATE = "WARNING: The missing " +
    ...
    public void warn() {
        //LOGGER
        System.err.printf(WARNING_TEMPLATE, param, value);
    }

    @Override
    public String toString() {
        return WARNING_TEMPLATE.replaceFirst("%s", this.param).replaceFirst("%s", this.value);
    }        
}